...
| Campo            | Valor                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status           | **Implementada (F1-F7 completas, 2026-08-15)** — decisões D-1 a D-8 ratificadas e aplicadas, teste manual em produção (Hostinger) já passou. Duas notas: D-2 aplicada sem o escape hatch (validação SPEC 050 direto, sem parâmetro faseado); a chave `too_many_rows_contacts` do §8 não foi criada — `Import.parseError.too_many_rows` já interpola `{max}`, reaproveitada com 10 000 para contatos. Falta só o commit |
| Data             | 2026-08-15                                                                                                                                                                                                                                                                                                                                                                                                             |
