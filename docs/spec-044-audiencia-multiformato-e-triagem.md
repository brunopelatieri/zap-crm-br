...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `ImportSourcePicker`     | `src/components/import/import-source-picker.tsx` (movido/generalizado pela SPEC 052 F4; opções do disparo em `src/components/broadcasts/audience/audience-source-options.ts`) | Substitui o grid de 4 cards do passo 2 por 6 fontes. Puramente apresentacional.                                               |
