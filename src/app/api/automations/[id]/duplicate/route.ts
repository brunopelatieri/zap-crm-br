...
export async function POST(
  ...
  // Scope to account, not to the exact creator — matches automations_select's
  // RLS (`is_account_member(account_id)`), so any teammate can duplicate an
  // automation a colleague created.
