...
export function formatRelative(
  ...
  if (diffSec < 3600) return tr('minutesAgo', { count: Math.floor(diffSec / 60) })
  if (diffSec < 86400) return tr('hoursAgo', { count: Math.floor(diffSec / 3600) })
  if (diffSec < 2_592_000) return tr('daysAgo', { count: Math.floor(diffSec / 86400) })
