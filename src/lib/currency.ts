...
export interface CurrencyOption {
  ...
  code: string;
  /**
   * English fallback name, e.g. "US Dollar". UI components should
   * prefer the translated name from the `Currencies` namespace in
   * `messages/*.json` (keyed by `code`) and fall back to this.
   */
  label: string;
