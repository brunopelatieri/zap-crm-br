 ...
 *
 * Message strings stay in English: this module is shared by the client
 * builder, the server activate path, and unit tests. Translating them
 * would require keyed issues + a client mapper (follow-up); until then
 * they match the API's English-only error policy.
 */
